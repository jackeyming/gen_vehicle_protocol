...
class Steeringcommand102 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  // config detail: {'bit': 0, 'description': '转向使能', 'enum': {0: 'STEERENCTRL_DISABLE', 1: 'STEERENCTRL_ABLE'}, 'is_signed_var': False, 'len': 1, 'name': 'SteerEnCtrl', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  Steeringcommand102* set_steerenctrl(Steeringcommand_102::SteerenctrlType steerenctrl);
 ...
 private:
  ...
  // config detail: {'bit': 0, 'description': '转向使能', 'enum': {0: 'STEERENCTRL_DISABLE', 1: 'STEERENCTRL_ABLE'}, 'is_signed_var': False, 'len': 1, 'name': 'SteerEnCtrl', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  void set_p_steerenctrl(uint8_t* data, Steeringcommand_102::SteerenctrlType steerenctrl);
 ...
 private:
  Steeringcommand_102::SteerenctrlType steerenctrl_;
