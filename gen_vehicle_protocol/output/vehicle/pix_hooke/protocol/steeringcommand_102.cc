...
#include "modules/canbus/vehicle/pix_hooke/protocol/steeringcommand_102.h"
...
void Steeringcommand102::Reset() {
  ...
  steerenctrl_ = Steeringcommand_102::STEERENCTRL_DISABLE;
  steeranglespeed_ = 0;
  steerangletarget_ = 0;
  checksum102_ = 0;
}
...
Steeringcommand102* Steeringcommand102::set_steerenctrl(
    Steeringcommand_102::SteerenctrlType steerenctrl) {
