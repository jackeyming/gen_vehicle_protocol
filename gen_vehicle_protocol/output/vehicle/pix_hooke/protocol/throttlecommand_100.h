...
class Throttlecommand100 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  // config detail: {'bit': 0, 'description': '加速使能', 'enum': {0: 'DRIVEENCTRL_DISABLE', 1: 'DRIVEENCTRL_ABLE'}, 'is_signed_var': False, 'len': 1, 'name': 'DriveEnCtrl', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  Throttlecommand100* set_driveenctrl(Throttlecommand_100::DriveenctrlType driveenctrl);
 ...
 private:
  ...
  // config detail: {'bit': 0, 'description': '加速使能', 'enum': {0: 'DRIVEENCTRL_DISABLE', 1: 'DRIVEENCTRL_ABLE'}, 'is_signed_var': False, 'len': 1, 'name': 'DriveEnCtrl', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  void set_p_driveenctrl(uint8_t* data, Throttlecommand_100::DriveenctrlType driveenctrl);
 ...
 private:
  Throttlecommand_100::DriveenctrlType driveenctrl_;
  double driveacc_;
