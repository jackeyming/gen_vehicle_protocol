...
class Brakecommand101 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  Brakecommand101* set_brakeenctrl(Brakecommand_101::BrakeenctrlType brakeenctrl);
  ...
  Brakecommand101* set_aebenctrl(Brakecommand_101::AebenctrlType aebenctrl);
 ...
 private:
  ...
  // config detail: {'bit': 0, 'description': '制动使能', 'enum': {0: 'BRAKEENCTRL_DISABLE', 1: 'BRAKEENCTRL_ABLE'}, 'is_signed_var': False, 'len': 1, 'name': 'BrakeEnCtrl', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  void set_p_brakeenctrl(uint8_t* data, Brakecommand_101::BrakeenctrlType brakeenctrl);

  // config detail: {'bit': 1, 'description': 'AEB使能', 'enum': {0: 'AEBENCTRL_DISABLE', 1: 'AEBENCTRL_ABLE'}, 'is_signed_var': False, 'len': 1, 'name': 'AebEnCtrl', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  void set_p_aebenctrl(uint8_t* data, Brakecommand_101::AebenctrlType aebenctrl);
 ...
 private:
  Brakecommand_101::BrakeenctrlType brakeenctrl_;
  Brakecommand_101::AebenctrlType aebenctrl_;
  double brakedec_;
