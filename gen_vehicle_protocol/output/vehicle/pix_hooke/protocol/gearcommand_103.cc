...
#include "modules/canbus/vehicle/pix_hooke/protocol/gearcommand_103.h"
...
void Gearcommand103::Reset() {
  ...
  gearenctrl_ = Gearcommand_103::GEARENCTRL_DISABLE;
  geartarget_ = Gearcommand_103::GEARTARGET_INVALID;
  checksum103_ = 0;
}

Gearcommand103* Gearcommand103::set_gearenctrl(
    Gearcommand_103::GearenctrlType gearenctrl) {
...
Gearcommand103* Gearcommand103::set_geartarget(
    Gearcommand_103::GeartargetType geartarget) {
