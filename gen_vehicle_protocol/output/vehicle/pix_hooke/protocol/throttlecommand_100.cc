...
#include "modules/canbus/vehicle/pix_hooke/protocol/throttlecommand_100.h"
...
void Throttlecommand100::Reset() {
  ...
  driveenctrl_ = Throttlecommand_100::DRIVEENCTRL_DISABLE;
  driveacc_ = 0.0;
...
Throttlecommand100* Throttlecommand100::set_driveenctrl(
    Throttlecommand_100::DriveenctrlType driveenctrl) {
