...
class Vcutransfer53b : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  bool vcupadautostart(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int acouttemp(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int acintemp(const std::uint8_t* bytes, const int32_t length) const;
};
