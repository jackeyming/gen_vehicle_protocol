...
class Uitrsensor3509 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double uiuss2tofdirect(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double uiuss3tofdirect(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double uiuss4tofdirect(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double uiuss5tofdirect(const std::uint8_t* bytes, const int32_t length) const;
};
