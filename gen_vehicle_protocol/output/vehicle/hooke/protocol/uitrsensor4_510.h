...
class Uitrsensor4510 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double uiuss2tofindirect(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double uiuss3tofindirect(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double uiuss4tofindirect(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double uiuss5tofindirect(const std::uint8_t* bytes, const int32_t length) const;
};
