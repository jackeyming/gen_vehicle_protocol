...
void Vinresp3516::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_hooke()->mutable_vinresp3_516()->set_vin16(vin16(bytes, length));
}

// config detail: {'bit': 7, 'is_signed_var': False, 'len': 8, 'name': 'vin16', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
